...
module.exports = {
  app: {
    title: process.env.APP_TITLE || "Tourism Api",
    ...
    swagger: {
      title: process.env.APP_TITLE || "Tourism Api",
      description:process.env.APP_DESC || "Tourism Api Desc",
  ...
  jwt: {
    ...
    logoutExpirationToken:process.env.JWT_LOGOUT_ACCESS_TOKEN_EXPIRATION_IN_SECONDS || 1
  },
};
